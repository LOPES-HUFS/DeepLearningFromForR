...
위 숫자 이미지는 0입니다. 과연 이 모델은 숫자 0을 맞출 수 있을까요?
...
보시다싶이 첫번째 인덱스를 약 0.9983% 확률로 표기합니다. R은 1부터 표시하기 때문에 정답 레이블은 1이됩니다. 이 말은 모델이 숫자 0을 정답으로 판단한 확률이 99%란 의미로 다시말해 모델이 이미지 데이터를 보고 숫자를 맞춘 것입니다.
